...
| Prompt cleanup | llama.cpp (Vulkan), Qwen2.5-3B-Instruct |
...
```powershell
./scripts/fetch-models.ps1 -Refiner   # development models; drop -Refiner to skip prompt cleanup
...
- [x] Prompt cleanup with a local LLM
